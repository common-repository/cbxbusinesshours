    ...
    <div class="meta-box-sortables">
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <p><span class="dashicons dashicons-editor-help"></span> <a href="<?php echo esc_url($plugin_url); ?>" target="_blank">Plugin Documentation</a></p>
                <p><span class="dashicons dashicons-star-half"></span> <a href="https://wordpress.org/support/plugin/cbxbusinesshours/reviews/#new-post" target="_blank">Review This Plugin</a></p>
            </div>
        </div>
        <div class="postbox">
        ...
        <div class="postbox">
            <h3><?php esc_html_e( 'Codeboxr News Updates', 'cbxbusinesshours' ) ?></h3>
            <div class="inside">
				<?php
