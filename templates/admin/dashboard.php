...
?>
<?php
$plugin_url = CBXBusinessHoursHelper::url_utmy( 'https://codeboxr.com/product/cbx-office-opening-business-hours-for-wordpress/' );
$doc_url    = CBXBusinessHoursHelper::url_utmy( 'https://codeboxr.com/product/cbx-office-opening-business-hours-for-wordpress/' );
?>
<div class="wrap">
    <div class="cbx-backend_container_header">
        <div class="cbx-backend_wrapper cbx-backend_header_wrapper">
            <div class="menu-heading">
                <img title="CBX Office Opening & Business Hours - Helps & Updates" src="<?php echo CBXBUSINESSHOURS_ROOT_URL . 'assets/images/icon_log.svg'
				?>" alt="CBX Office Opening & Business Hours - Helps & Updates" width="32" height="32">
                <h2 class="wp-heading-inline wp-heading-inline-setting">
					<?php esc_html_e( 'CBX Office Opening & Business Hours - Helps & Updates', 'cbxbusinesshours' ); ?>
                </h2>
            </div>
            <a href="<?php echo admin_url() . 'options-general.php?page=cbxbusinesshours' ?>" class="button button-primary
            save-settings"> <?php esc_html_e( 'Go to Settings', 'cbxbusinesshours' ); ?><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAABmJLR0QA/wD/AP+gvaeTAAAARUlEQVRIie3PoQoAIBRD0eGPa3x/bJxF0GLbgrBThd0nEBFSJMsdoDXCo14PSgUAzfYdYMoXr+u7fPwKeMZ3YNjGIz62APJohRdPxDxbAAAAAElFTkSuQmCC"/></a>
        </div>
    </div>
            ...
            <div class="cbx-backend-row">
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                    ...
                    <div class="cbx-backend-card">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Get Free & Pro Addons', 'cbxbusinesshours' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-row">
                                        ...
                                        <div class="feature-card-body static">
                                            <div class="feature-card-header">
                                                <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                   target="_blank"> <img src="https://codeboxr.com/wp-content/uploads/productshots/16617-profile.png"
                                            ...
                                            <div class="feature-card-description">
                                                <h3>
                                                    <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                       target="_blank">CBX Office Opening & Business Hours Pro Addon</a></h3>
                                                <p>Pro features for CBX Office Opening & Business Hours plugin.</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="cbx-backend-card dashboard-plugin-Integration">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Third Party plugin Integration', 'cbxbusinesshours' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <p>
									...
									<?php esc_html_e( 'Coming Soon ...', 'cbxbusinesshours' ); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Other WordPress Plugins', 'cbxbusinesshours' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
							<?php
							...
							if ( function_exists( 'fetch_feed' ) ) {
								...
								if ( ! is_wp_error( $feed ) ) : $feed->init();
									...
									foreach ( $blocks as $block ) {
										...
										$url = CBXBusinessHoursHelper::url_utmy( $url ); ?>
                                        <div class="cbx-backend-settings-row">
                ...
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                    ...
                    <div class="cbx-backend-card dashboard-support">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Help & Supports', 'cbxbusinesshours' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <a href="https://codeboxr.com/contact-us" target="_blank">
									...
									<?php esc_html_e( 'Access our Premium Support', 'cbxbusinesshours' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="mailto:info@codeboxr.com&subject=Need%20support%20for%20CBX%20Business%20Hours" target="_blank">
									...
									<?php esc_html_e( 'Quick Support (Email)', 'cbxbusinesshours' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $plugin_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'CBX Office Opening & Business Hours Plugin Information', 'cbxbusinesshours' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $doc_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'Read the CBX Office Opening & Business Hours User Guide', 'cbxbusinesshours' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://wordpress.org/support/plugin/cbxbusinesshours/reviews/#new-post" target="_blank">
                                    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<?php esc_html_e( 'Rate Our Plugin', 'cbxbusinesshours' ); ?> </a>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Changelog', 'cbxbusinesshours' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                            ...
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[Fixed]</strong>Fixed a php warning for a wrong spelled php constant.</li>
                                    <li><strong>[Fixed]</strong>Current day highlight wrong in some condition fixed.</li>
                                    <li><strong>[New]</strong> New param ‘honor_post_meta’ in shortcode .</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[Fixed]</strong> Gutenberg block register compatibility fix for old sites
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Codeboxr News Updates', 'cbxbusinesshours' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
							<?php
